...
import { PricingPlanType } from "@/types/app";
...
const PricingCard = ({plan}: {plan: PricingPlanType}) => {
  return (
    ...
    >
      {plan.popular && (
        <div className="absolute -top-3 left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-indigo-600 to-violet-600 text-white">
          Most Popular
        </div>
      )}
      <div className="text-center pb-2">
        ...
        <div className="mt-4">
          <span className="text-4xl font-bold text-gray-900">{plan.price ? plan.price : "Custom"}</span>
          {plan.price !== null && (
